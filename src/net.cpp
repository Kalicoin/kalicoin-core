...
/*#ifndef UPNPDISCOVER_SUCCESS
    ...
    *//* miniupnpc 1.6 *//*
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kalicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"159.65.1.66", "159.65.1.66"},
    {"159.65.13.64", "159.65.13.64"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kalicoin is probably already running."), addrBind.ToString().c_str());
        else
